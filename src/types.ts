/**
 *  This type has been converted from: https://code.visualstudio.com/api/references/theme-color
 *  use regex /^(?:\s*)([\w\.]+:)([\s\w;'"\(\)#\d\.]+)(?<!string;)$/ to /**\n*$2\n*\/\n$1:string;
 */
...
export type EditorGroupsAndTabs = {
  /**
...
export type EditorWidgetColors = {
  /**
...
export type MergeConflictsColors = {
  /**
...
export type KeybindingLabelColors = {
  /**
...
export type KeyboardShortcutTableColors = {
  /**
...
export type IntegratedTerminalColors = {
  /**
...
export type SourceControlColors = {
  /**
...
export type SettingsEditorColors = {
  /**
...
export type ExtensionColors = {
  "workbench.colorCustomizations": string;
};
...
export type ScopeName = `${ScopeSelector}.${string}`;
